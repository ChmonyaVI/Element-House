(() => {
    ...
    function initSliders() {
        if (document.querySelector(".populars__slider")) new core(".populars__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 7,
            ...
            loop: true,
            navigation: {
                prevEl: ".title-populars__button-left",
                nextEl: ".title-populars__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.5,
        ...
        if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
            ...
            navigation: {
                prevEl: ".title-reviews__button-left",
                nextEl: ".title-reviews__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.5,
        ...
        if (document.querySelector(".images-content__slider")) new core(".images-content__slider", {
            ...
            navigation: {
                prevEl: ".images-content-swiper-button-prev",
                nextEl: ".images-content-swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".more-models__slider")) new core(".more-models__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 7,
            ...
            loop: true,
            navigation: {
                prevEl: ".title-models__button-left",
                nextEl: ".title-models__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.5,
    ...
    function cloneSlider() {
        ...
        const featuredWrapper = document.querySelector(".block-reviews__wrapper");
        const featuredWrapperClone = featuredWrapper.cloneNode(true);
